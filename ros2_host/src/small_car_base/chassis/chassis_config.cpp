...
constexpr std::array<ParameterDefinition, 23> kParameterDefinitions = {{
    {1, "odom_mm_per_tick_num", 1000, 5000, false},
    {2, "gamepad_forward_start", 0, 1000, false},
    {3, "gamepad_reverse_start", 0, 1000, false},
    {4, "gamepad_drive_max", 0, 1000, false},
    {5, "gamepad_turn_start", 0, 1000, false},
    {6, "gamepad_turn_max", 0, 1000, false},
    {7, "ultra_near_distance_mm", 0, 5000, false},
    {8, "gyro_lsb_per_dps_x10", 100, 300, false},
    {9, "wheel_track_mm", 0, 1000, false},
    {10, "yaw_gyro_weight_permille", 0, 1000, false},
    {11, "attitude_gyro_weight_permille", 0, 1000, false},
    {12, "imu_roll_offset_mdeg", -30000, 30000, false},
    {13, "imu_pitch_offset_mdeg", -30000, 30000, false},
    {14, "max_linear_speed_mm_s", 100, 3000, false},
    {15, "max_angular_speed_mrad_s", 100, 10000, false},
